...
.directive('ionicPasswordShowHide', function($compile, $timeout) {
	return {
		restrict: 'A',
		scope: {
			ngModel: '='
		...
		controller: function($scope, $element, $attrs) {
			...
			$scope.btnShowClass = element.getAttribute('data-password-show-btn-class') || 'ion-eye';
			$scope.btnHideClass = element.getAttribute('data-password-hide-btn-class') || 'ion-eye-disabled';
